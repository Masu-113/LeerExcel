...
def sobrescribir_imagen_con_excel(imagen_path, excel_path, hoja_excel, rango_celdas, fuente_path=None, tamaño_fuente=12):
    try:
        # Cargar la imagen
        ...
        for fila in datos_array:
            ...
            for idx, dato in enumerate(fila):
                ...
                posicion_x_columna += anchos_columnas[idx] + 42  #espacios entre column
...
sobrescribir_imagen_con_excel(imagen_a_modificar, archivo_excel, hoja_a_usar, rango_a_leer, fuente_personalizada, tamaño_fuente)
